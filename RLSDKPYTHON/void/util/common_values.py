...
GOAL_HEIGHT = 642.775
GOAL_WIDTH_FROM_CENTER = 892.755  # Half of goal width (~1783 total)
GRAVITY_Z = -650.0
...
# Count of boost locations to mirror C++ CommonValues::BOOST_LOCATIONS_AMOUNT
BOOST_LOCATIONS_AMOUNT = len(BOOST_LOCATIONS)
