...
class RLGymPPOBot(BaseAgent):
    def __init__(self, name, team, index):
        ...
        # CustomObs - Reproduction EXACTE du C++ CustomObs.cpp
    ...
    def get_output(self, packet: GameTickPacket) -> SimpleControllerState:
        ...
        if self.update_action:
            ...
            obs = active_obs_builder.build_obs(self.game_state, self.index)
            self.action = active_agent.act(obs)
            
            # Enregistrer l'action pour la prochaine frame
            active_obs_builder.set_prev_action(self.action)
